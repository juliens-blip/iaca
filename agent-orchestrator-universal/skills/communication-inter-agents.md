...
│  Window 1: antigravity-proxy │  Proxy Antigravity           │
│  Window 2: antigravity │  Claude via proxy                  │
│  Window 3: claude      │  Claude Code (orchestrateur)       │
│  Window 4: amp         │  AMP CLI                           │
...
3: claude* (1 panes) [206x23] @3 (active)
4: amp (1 panes) [80x24] @4
