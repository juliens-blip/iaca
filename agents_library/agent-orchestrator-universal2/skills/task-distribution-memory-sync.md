...
### Contexte
Session tmux `orchestration-moana`, 5 LLMs : AMP (w4), Codex-core (w2), Codex (w5), Antigravity (w7), Ollama (w8).
...
**3. Travailler** (l'orchestrateur fait ses propres tâches pendant ce temps)
